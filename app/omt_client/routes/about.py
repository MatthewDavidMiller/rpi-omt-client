...
try:
    from ...state_store import read_text
except ImportError:
    from state_store import read_text  # type: ignore[no-redef]
...
def about():
    ...
    return render_template(
        ...
        third_party_notices=_legal_text(
            settings.third_party_notices_file, "Third-party notices"
        ),
    )
