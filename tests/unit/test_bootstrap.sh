...
require 'BEGIN US HTTPS APK MIRRORS' "bootstrap must pin US HTTPS apk mirrors"
require 'https://mirrors\.edge\.kernel\.org' "bootstrap must use the kernel.org HTTPS mirror"
